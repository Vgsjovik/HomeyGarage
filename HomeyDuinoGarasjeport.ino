/*
   ...
   Garasjeportkoden. Du må gjøre endring på linje:
   37 - Wifi-SSID og Passord
   Eventuelt: 45, 54 (Navn på enhet og trigger)
   Dersom signalet er for kort eller for langt, så må det endres på linje 140
...
int SIGNAL = 2;
//Pin 2 er D4 og blå LED er koblet til denne.
...
void setup() {
  ...
  */
  ...
  digitalWrite(SIGNAL, LOW); //Det er lurt å sette porten til LOW fra start
}
...
void loop() {
  ...
  if(currentMillis - previousMillis > interval) {
    ...
    bool success = Homey.trigger("mytrigger", "Hello world 2019");
    /* Note:
...
void onExampleAction() {
  ...
  delay(200); //Dette lar signalet stå på i 200 ms.
